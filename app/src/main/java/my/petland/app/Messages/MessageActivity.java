package my.petland.app.Messages;
...
import my.petland.app.Messages.Adapter.MessageAdapter;
import my.petland.app.Messages.Model.Chat;
import my.petland.app.Messages.Notification.APIService;
import my.petland.app.Messages.Notification.Client;
import my.petland.app.Messages.Notification.Data;
import my.petland.app.Messages.Notification.MyResponse;
import my.petland.app.Messages.Notification.NotificationSender;
import my.petland.app.Messages.Notification.Token;
import my.petland.app.R;
import my.petland.app.models.Users;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {  // event nút Send
                notify = true;
