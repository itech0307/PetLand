...
import my.petland.app.ReusableCode.ReusableCodeForAll;
import my.petland.app.models.Passwords;
import my.petland.app.models.Users;
import my.petland.app.models.privatedetails;
...
//        useridd = FAuth.getCurrentUser().getUid();
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                username = Username.getEditText().getText().toString().trim();                email = Email.getEditText().getText().toString().trim();
